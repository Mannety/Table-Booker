...
from .factories import RestaurantFactory, TableFactory, UserFactory, SettingFactory, BookingFactory
...
class UpdateMyBookingsTests(TestCase):
    ...
    def test_successful_update(self):
        ...
        self.assertEqual(message.tags, "info")
        self.assertTrue(f"You successfully updated {self.booking.restaurant.name} booking" in message.message)
        self.assertRedirects(response, "/my-bookings", status_code=302) 
...
class BookingFormTest(TestCase):
    def setUp(self):
        ...
        self.min_guest = 3
        self.restaurant = RestaurantFactory()
        self.setting = SettingFactory(restaurant=self.restaurant, min_guest=self.min_guest)
